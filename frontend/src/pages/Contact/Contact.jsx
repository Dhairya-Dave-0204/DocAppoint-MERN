    ...
    <>
      ...
      <div className="grid grid-cols-1 px-12 py-6 xl:px-60 md:grid-cols-2 lg:grid-cols-3">
        <div className="flex flex-col items-center justify-center p-10">
          ...
          <p className="mb-2 text-center">Email us for general queries, including marketing <br /> and partnership opportunities.</p>
          <p className="cursor-pointer hover:underline hover:text-primary">hello@docappoint.com</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center p-10">
          ...
          <p className="mb-2 text-center">Call us to speak to a member of our team. We <br /> are always happy to help.</p>
          <p className="cursor-pointer hover:underline hover:text-primary">+91 1234567890</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center p-10">
          ...
          <p className="mb-2 text-center">Loacte us on the map globally so that you can <br /> solve your issues physically.</p>
          <p className="cursor-pointer hover:underline hover:text-primary">loaction link</p>
        </div>
      </div>
    </>
  );
